...
public abstract class TomcatUtils {
	...
	public static Embedded buildNormalServer(int port, String contextPath) {
		return buildNormalServer(port, contextPath,
				System.getProperty("project.name"), "UTF-8");
	}
	 ...
	 */
	public static Embedded buildNormalServer(int port, String contextPath,
			String serverName, String encoding) {
		...
		Host host = tomcat.createHost("127.0.0.1", tomcat.getCatalinaHome()
				+ "/webapps");
		Context context = tomcat.createContext(contextPath,
